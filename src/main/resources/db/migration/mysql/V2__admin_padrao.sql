...
VALUES (NULL, '82198127000121', CURRENT_DATE(), CURRENT_DATE(), 'VFB Tecnology');
...
VALUES (NULL, '03136997123', CURRENT_DATE(), CURRENT_DATE(), 'admin@bellaver.com', 'ADMIN', 'ROLE_ADMIN', NULL, NULL, 
